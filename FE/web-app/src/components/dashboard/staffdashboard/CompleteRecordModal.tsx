...
import { X, CheckSquare, AlertCircle, Calendar } from "lucide-react";
...
export function CompleteRecordModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!checkoutDate) {
      setError("Checkout date is required");
      return;
    }
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-sm text-blue-800">
                  ...
                  <strong>COMPLETED</strong> and set the checkout date. Make
                  sure all repairs are finished and verified.
                </p>
              </div>
