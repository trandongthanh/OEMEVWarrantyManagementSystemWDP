...
// Interactive Car Model Component (Same as login)
...
export default function RegisterPage() {
  ...
  return (
    <div className="auth-page min-h-screen bg-black flex overflow-hidden relative">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 relative z-10 overflow-y-auto ml-12">
        ...
        <motion.div
          ...
          className="w-full max-w-md relative z-20 my-8"
        >
          <div className="mesh-glass rounded-2xl p-6 shadow-2xl">
            {/* Header */}
            <div className="text-center mb-6">
              <div className="flex items-center justify-center gap-3 mb-4">
                <Shield className="w-8 h-8 text-purple-400" />
                <span className="text-xl font-bold text-white">EVWarranty</span>
              </div>
              <h1 className="text-2xl font-bold text-white mb-2">
                Create Account
              </h1>
              <p className="text-gray-400 text-sm">
                Join us to protect your EV investment
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent transition-all backdrop-blur-sm"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full pl-12 pr-12 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent transition-all backdrop-blur-sm"
              ...
              <div className="flex items-start space-x-3">
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-4 h-4 text-purple-400 bg-white/10 border-white/20 rounded focus:ring-purple-400 focus:ring-2 mt-1"
                />
                <label
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full py-3 px-4 bg-gradient-to-r from-purple-500 to-blue-600 text-white font-semibold rounded-lg hover:from-purple-600 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 focus:ring-offset-black transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? (
      ...
      <div className="hidden lg:flex w-1/2 items-center justify-center relative">
        {/* 3D Model Background */}
        <div className="absolute inset-0 bg-gradient-to-l from-purple-900/10 to-transparent"></div>
